  ...
  static getNoteTpl() {
    return `
        <div class="tc-note">
            ...
            <div class="tc-note-bottom">
              <a href="https://www.facebook.com/"><i class="fab fa-facebook icon-bottom"></i></a>
              <a href="https://www.twitter.com/"><i class="fab fa-twitter icon-bottom"></i></a>
              <button onclick="copyText()"><i class="fas fa-copy icon-bottom"></i></button>
